...
})({"cJEuA":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "5df7dd436f6f835d";
"use strict";
...
},{}],"aYwqM":[function(require,module,exports) {
...
const setup = ()=>{
    ...
    const chkKeydown = (0, _domJs.Forms).checkbox(`#evKeydown`);
    const chkKeyup = (0, _domJs.Forms).checkbox(`#evKeyup`);
    const chkKeypress = (0, _domJs.Forms).checkbox(`#evKeypress`);
    const handle = (ev)=>{
        const s = toString(ev);
        log.log(s.split(`\n`).join(``));
        lastEl.innerText = s;
...
},{"ixfx/dist/dom.js":"ao7hr"}],"ao7hr":[function(require,module,exports) {
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["cJEuA","aYwqM"], "aYwqM", "parcelRequirefc40")

//# sourceMappingURL=index.6f6f835d.js.map
