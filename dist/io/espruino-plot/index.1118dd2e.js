...
})({"1VkBu":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "035573701118dd2e";
"use strict";
...
},{}],"k83DB":[function(require,module,exports) {
/**
 * This playground is not meant for extending in code
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _ioJs = require("ixfx/dist/io.js");
var _snarkdownEsJs = require("./snarkdown.es.js");
var _snarkdownEsJsDefault = parcelHelpers.interopDefault(_snarkdownEsJs);
var _domJs = require("ixfx/dist/dom.js");
var _visualJs = require("ixfx/dist/visual.js");
...
let state = Object.freeze({
    ...
    /** @type {boolean} */ jsonWarning: false,
    /** @type {boolean} */ clearedWelcome: false,
    /** @type {Espruino.EspruinoDevice|undefined} */ p: undefined,
...
setInterval(() => {
  ...
  USB.println(JSON.stringify(data));
    ...
    // @ts-ignore
    plot: new (0, _visualJs.Plot2).Plot(document.getElementById(`plotCanvas`), {
        autoSize: true,
        axisColour: (0, _visualJs.Colour).getCssVariable(`fg`)
    }),
...
const connect = async ()=>{
    ...
    try {
        if (state.board === `puck`) {
            const p = await (0, _ioJs.Espruino).connectBle();
            updateState({
                p
            });
        } else if (state.board === `pico`) {
            const p = await (0, _ioJs.Espruino).serial();
            updateState({
                p
            });
        }
...
const setup = ()=>{
    ...
    // Setup UI
    _domJs.Forms.textAreaKeyboard(txtCode);
    ...
    document.getElementById(`btnHelp`)?.addEventListener(`click`, async (evt)=>{
        ...
        try {
            ...
            if (resp.ok) {
                ...
                contentEl.innerHTML = (0, _snarkdownEsJsDefault.default)(md);
            } else {
    ...
    document.getElementById(`txtCode`)?.addEventListener(`keyup`, (evt)=>{
        if (evt.key === `Enter` && evt.ctrlKey) send();
    });
...
function updateInitialCode() {
    ...
    if (lastCode === null) txtCode.value = initialCode.trim();
    else txtCode.value = lastCode;
}
/**
 * Update state
...
},{"ixfx/dist/io.js":"k8lTE","./snarkdown.es.js":"6NV1x","ixfx/dist/dom.js":"ao7hr","ixfx/dist/visual.js":"4Gq0h","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"k8lTE":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6NV1x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ao7hr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"4Gq0h":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Colour", ()=>(0, _chunkG5YZ6YRDJs.Colour_exports));
parcelHelpers.export(exports, "Drawing", ()=>(0, _chunkG5YZ6YRDJs.Drawing_exports));
parcelHelpers.export(exports, "ImageDataGrid", ()=>(0, _chunkG5YZ6YRDJs.ImageDataGrid_exports));
parcelHelpers.export(exports, "Palette", ()=>(0, _chunkG5YZ6YRDJs.Palette_exports));
parcelHelpers.export(exports, "Plot", ()=>(0, _chunkG5YZ6YRDJs.Plot_exports));
parcelHelpers.export(exports, "Plot2", ()=>(0, _chunkG5YZ6YRDJs.Plot2_exports));
parcelHelpers.export(exports, "SceneGraph", ()=>(0, _chunkG5YZ6YRDJs.SceneGraph_exports));
parcelHelpers.export(exports, "Svg", ()=>(0, _chunkG5YZ6YRDJs.Svg_exports));
parcelHelpers.export(exports, "Video", ()=>(0, _chunkG5YZ6YRDJs.Video_exports));
var _chunkG5YZ6YRDJs = require("./chunk-G5YZ6YRD.js");
var _chunk4DC2CRSBJs = require("./chunk-4DC2CRSB.js");

},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["1VkBu","k83DB"], "k83DB", "parcelRequirefc40")

//# sourceMappingURL=index.1118dd2e.js.map
