...
})({"jt7Ns":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "7f0c05268a0e8b43";
"use strict";
...
},{}],"dt8OO":[function(require,module,exports) {
/**
 * Demonstrates a 'pinch to zoom' style gesture
 */ var _pressureOrForceJs = require("./pressureOrForce.js");
...
/** @type {import("./pressureOrForce.js").PressureForceState} */ let state = {
    webkitForce: 0,
    normalised: 0,
    pointerPressure: 0
};
...
const setup = ()=>{
    ...
    (0, _pressureOrForceJs.pressureOrForce)(el, (state)=>{
        updateState(state);
        useState();
    });
};
...
},{"./pressureOrForce.js":"gM16P"}],"gM16P":[function(require,module,exports) {
 ...
 */ parcelHelpers.export(exports, "pressureOrForce", ()=>pressureOrForce);
var _dataJs = require("ixfx/dist/data.js");
function pressureOrForce(el, onChange, opts = {}) {
    ...
    /** @type {PressureForceState} */ let elState = {
        webkitForce: 0,
        normalised: 0,
        pointerPressure: 0
    };
   ...
   */ const updateElState = (s)=>{
    ...
    const updateWebkitForce = (evt)=>{
        ...
        updateElState({
            ...
            normalised: (0, _dataJs.clamp)((0, _dataJs.scale)(evt.webkitForce, webkitForceMin, webkitForceMax))
        });
    };
   ...
   */ const updatePressure = (evt)=>{
        ...
        if (evt.type === `pointerleave` || evt.type === `pointerup`) {
            if (resetOnLeave) updateElState({
                pointerPressure: 0,
                normalised: 0,
                webkitForce: 0
            });
        } else if (seenWebkitForce && evt.pointerType === `mouse`) // Don't trample on normalised value if it seems we have Webkit force events instead
        updateElState({
...
},{"ixfx/dist/data.js":"jF4D4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jF4D4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jt7Ns","dt8OO"], "dt8OO", "parcelRequirefc40")

//# sourceMappingURL=index.8a0e8b43.js.map
