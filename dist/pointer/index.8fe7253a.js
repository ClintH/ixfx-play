...
})({"btn7C":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "ba05911e8fe7253a";
"use strict";
...
},{}],"hTJt8":[function(require,module,exports) {
var _dom = require("ixfx/dist/dom");
 ...
 */ const updatePointer = (ev)=>{
    ...
    if (pointerType === `pen`) {
        ...
        if (ev.altitudeAngle && ev.azimuthAngle) penStr += `altitudeAngle ${ev.altitudeAngle}<br />azimuthAngle: ${ev.azimuthAngle})<br />`;
        penStr += `<br />`;
    }
...
const setup = ()=>{
    ...
    if (!pointerEl) return;
    const chkPointermove = (0, _dom.Forms).checkbox(`#evPointermove`);
    const chkPointerenter = (0, _dom.Forms).checkbox(`#evPointerenter`);
    const chkPointerleave = (0, _dom.Forms).checkbox(`#evPointerleave`);
    const chkPointerover = (0, _dom.Forms).checkbox(`#evPointerover`);
    const chkPointerdown = (0, _dom.Forms).checkbox(`#evPointerdown`);
    const chkPointerup = (0, _dom.Forms).checkbox(`#evPointerup`);
...
},{"ixfx/dist/dom":"ao7hr"}],"ao7hr":[function(require,module,exports) {
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["btn7C","hTJt8"], "hTJt8", "parcelRequirefc40")

//# sourceMappingURL=index.8fe7253a.js.map
