...
})({"iUf9j":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "000137e77d955e66";
"use strict";
...
},{}],"dSTzr":[function(require,module,exports) {
/**
...
var _collectionsJs = require("ixfx/dist/collections.js");
const settings = Object.freeze({
    log: (0, _domJs.log)(`#log`, {
        css: `
...
let state = Object.freeze({
    /** @type {'puck'|'pico'} */ board: `puck`,
    /** @type Espruino.EspruinoDevice|undefined */ espruino: undefined,
    history: (0, _collectionsJs.Stacks).mutable(),
    /** @type {number} */ historyIndex: 0
});
const inputSel = ()=>{
...
document.getElementById(`btnDemo`)?.addEventListener(`click`, async ()=>{
  ...
  `;
    ...
    if (!connected) log.log(`// Connect to an Espruino to run this for real`);
    await (0, _flowJs.forEachAsync)(demos.trim().split(`\n`), async (demo)=>{
        if (!demo) return;
        demo = demo.trim();
        if (demo.startsWith(`//`) || espruino === undefined || !espruino.isConnected) {
            const el = log.log(demo);
            el?.classList.add(`meta`);
        } else await send(demo);
        return;
    }, connected ? 1000 : 400);
});
...
document.getElementById(`btnConnect`)?.addEventListener(`click`, async ()=>{
    ...
    try {
        if (state.board === `puck`) {
            const espruino = await (0, _ioJs.Espruino).connectBle();
            updateState({
                espruino
            });
        } else if (state.board === `pico`) {
            const espruino = await (0, _ioJs.Espruino).serial();
            updateState({
                espruino
            });
        }
...
const setup = ()=>{
    ...
    txtInput.addEventListener(`keyup`, (evt)=>{
        ...
        if (evt.key === `ArrowUp` || evt.key === `ArrowDown`) {
            if (evt.key === `ArrowUp`) historyIndex = Math.max(0, historyIndex - 1);
            else if (evt.key === `ArrowDown`) historyIndex = Math.min(history.data.length - 1, historyIndex + 1);
            updateState({
                historyIndex
            });
...
function onEspruinoChange(e) {
    ...
    if (e.newState === `connected`) setDisconnected(false);
 ...
 */ function updateState(s) {
    ...
    if (s.espruino) {
        if (prevEspruino) prevEspruino.removeEventListener(`change`, onEspruinoChange);
        s.espruino.addEventListener(`change`, onEspruinoChange);
        setDisconnected(false);
    }
}

},{"ixfx/dist/io.js":"k8lTE","ixfx/dist/dom.js":"ao7hr","ixfx/dist/flow.js":"235MD","ixfx/dist/collections.js":"agGi2"}],"k8lTE":[function(require,module,exports) {
...
},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"agGi2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "Arrays", ()=>(0, _chunkG5YZ6YRDJs.Arrays_exports));
parcelHelpers.export(exports, "Maps", ()=>(0, _chunkG5YZ6YRDJs.Map_exports));
parcelHelpers.export(exports, "QueueImmutable", ()=>(0, _chunk4DC2CRSBJs.QueueImmutable));
parcelHelpers.export(exports, "QueueMutable", ()=>(0, _chunk4DC2CRSBJs.QueueMutable));
parcelHelpers.export(exports, "Queues", ()=>(0, _chunk4DC2CRSBJs.queue_exports));
parcelHelpers.export(exports, "SetStringImmutable", ()=>(0, _chunkG5YZ6YRDJs.SetStringImmutable));
parcelHelpers.export(exports, "SetStringMutable", ()=>(0, _chunkG5YZ6YRDJs.SetStringMutable));
parcelHelpers.export(exports, "Sets", ()=>(0, _chunkG5YZ6YRDJs.set_exports));
parcelHelpers.export(exports, "StackImmutable", ()=>(0, _chunkG5YZ6YRDJs.StackImmutable));
parcelHelpers.export(exports, "StackMutable", ()=>(0, _chunkG5YZ6YRDJs.StackMutable));
parcelHelpers.export(exports, "Stacks", ()=>(0, _chunkG5YZ6YRDJs.stack_exports));
parcelHelpers.export(exports, "Trees", ()=>(0, _chunkG5YZ6YRDJs.Trees_exports));
parcelHelpers.export(exports, "circularArray", ()=>(0, _chunkG5YZ6YRDJs.circularArray));
var _chunkG5YZ6YRDJs = require("./chunk-G5YZ6YRD.js");
var _chunk4DC2CRSBJs = require("./chunk-4DC2CRSB.js");

},{"./chunk-G5YZ6YRD.js":"igz1E","./chunk-4DC2CRSB.js":"jTrL9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["iUf9j","dSTzr"], "dSTzr", "parcelRequirefc40")

//# sourceMappingURL=index.7d955e66.js.map
