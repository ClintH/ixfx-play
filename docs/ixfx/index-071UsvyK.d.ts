...
declare const getSizeWithBorder: (elOrQuery: HTMLElement | string) => RectPositioned;
/**
...
declare const index_getSizeWithBorder: typeof getSizeWithBorder;
