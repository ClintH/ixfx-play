...
import {
  StackImmutable
} from "./chunk-43QEGSAG.js";
import {
  immutable
} from "./chunk-V5ZRK7VT.js";
import {
  Empty,
  Ops,
  guard2,
...
var ElementSizer = class _ElementSizer {
  ...
  #computeSizeBasedOnParent(parentSize) {
    ...
    const size = getBoundingClientRectWithBorder(this.#el);
    console.log(`adjusted size: `, size);
    console.log(`regular:`, this.#el.getBoundingClientRect());
    return { width, height };
  }
  #onParentResize(args) {
    console.log(args);
...
//# sourceMappingURL=chunk-XOVA53KU.js.map