...
import { a as MergeReconcile, b as MinMaxAvgOpts, M as MinMaxAvgTotal } from './Types-BRWlstb4.js';
import { r as randomElement, b as randomElementWeightedSource, a as randomIndex, c as randomPluck, s as shuffle } from './Random-KEU29q35.js';
import { a as average, b as averageWeighted, d as dotProduct, m as max, c as maxFast, e as maxIndex, f as min, g as minFast, h as minIndex, t as total, i as totalFast, v as validNumbers, w as weight } from './AverageWeighted-_MkZMh6Q.js';
...
declare const index_ICircularArray: typeof ICircularArray;
declare const index_MergeReconcile: typeof MergeReconcile;
...
declare namespace index {
  export { index_ICircularArray as ICircularArray, index_MergeReconcile as MergeReconcile, index_MinMaxAvgOpts as MinMaxAvgOpts, index_MinMaxAvgTotal as MinMaxAvgTotal, index_additionalValues as additionalValues, index_average as average, index_averageWeighted as averageWeighted, index_chunks as chunks, index_circularArray as circularArray, index_contains as contains, index_containsDuplicateInstances as containsDuplicateInstances, index_containsDuplicateValues as containsDuplicateValues, index_cycle as cycle, index_dotProduct as dotProduct, index_ensureLength as ensureLength, index_filterAB as filterAB, index_filterBetween as filterBetween, index_flatten as flatten, index_groupBy as groupBy, index_guardArray as guardArray, index_guardIndex as guardIndex, index_insertAt as insertAt, index_interleave as interleave, index_isContentsTheSame as isContentsTheSame, index_isEqual as isEqual, index_max as max, index_maxFast as maxFast, index_maxIndex as maxIndex, index_mergeByKey as mergeByKey, index_min as min, index_minFast as minFast, index_minIndex as minIndex, index_minMaxAvg as minMaxAvg, index_pairwise as pairwise, index_pairwiseReduce as pairwiseReduce, index_randomElement as randomElement, index_randomElementWeightedSource as randomElementWeightedSource, index_randomIndex as randomIndex, index_randomPluck as randomPluck, index_remove as remove, index_sample as sample, index_shuffle as shuffle, index_sortByNumericProperty as sortByNumericProperty, index_total as total, index_totalFast as totalFast, index_unique as unique, index_until as until, index_validNumbers as validNumbers, index_weight as weight, index_without as without, index_withoutUndefined as withoutUndefined, index_zip as zip };
}

export { sortByNumericProperty as A, unique as B, until as C, zip as D, additionalValues as a, chunks as b, cycle as c, contains as d, containsDuplicateValues as e, containsDuplicateInstances as f, ensureLength as g, isEqual as h, index as i, isContentsTheSame as j, filterAB as k, filterBetween as l, without as m, flatten as n, groupBy as o, guardArray as p, guardIndex as q, insertAt as r, interleave as s, mergeByKey as t, minMaxAvg as u, pairwise as v, withoutUndefined as w, pairwiseReduce as x, remove as y, sample as z };
