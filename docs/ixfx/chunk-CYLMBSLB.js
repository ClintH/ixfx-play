...
var ElementSizer = class _ElementSizer {
  ...
  #computeSizeBasedOnParent(parentSize) {
    ...
    const borderW = getComputedStyle(this.#el).borderWidth;
    ...
    console.log(`borderW: ${borderW} tw: ${tw} bw: ${bw} left: ${leftW} right: ${rightW}`);
    return { width, height };
  }
  #onParentResize(args) {
    console.log(args);
...
//# sourceMappingURL=chunk-CYLMBSLB.js.map