...
var Box = class {
  ...
  *getChildren() {
  ...
  measureSelf(opts, parent) {
    ...
    size = desired ? clamp4(desired, context) : context;
...
var CartesianCanvasPlot = class {
  ...
  #regionSpaceToValue(scr, clamped) {
    const ds = this.getCurrentRange();
...
//# sourceMappingURL=chunk-XZ5N4XHE.js.map