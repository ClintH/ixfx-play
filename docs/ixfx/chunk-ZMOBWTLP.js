import {
  points,
  uniqueInstances
} from "./chunk-3SO7MHPU.js";
import {
  Forms_exports
} from "./chunk-VQMLRC2Q.js";
import {
  CanvasHelper
} from "./chunk-VHJQUIQY.js";
import {
  DomRx_exports,
  ElementSizer
} from "./chunk-CYLMBSLB.js";
import {
  SvgElements_exports
...
var getComputedPixels = (elOrQuery, properties) => {
  ...
  for (const prop of properties) {
    ...
    if (typeof v === `string`) {
      if (v.endsWith(`px`)) {
        ret[prop] = Number.parseFloat(v.substring(0, v.length - 2));
      } else {
        throw new Error(`Property '${String(prop)}' does not end in 'px'. Value: ${v}`);
      }
    } else {
      throw new Error(`Property '${String(prop)}' is not type string. Got: ${typeof v} Value: ${v}`);
    }
  }
  return ret;
};
...
//# sourceMappingURL=chunk-ZMOBWTLP.js.map