...
declare namespace index {
  export { type index_Adsr as Adsr, type index_AdsrIterableOpts as AdsrIterableOpts, type index_AdsrOpts as AdsrOpts, type index_AdsrTimingOpts as AdsrTimingOpts, type index_CompleteEvent as CompleteEvent, Easing as Easings, type index_EnvelopeOpts as EnvelopeOpts, Envelope as Envelopes, type index_Events as Events, index_Forces as Forces, index_JitterOpts as JitterOpts, index_Jitterer as Jitterer, Oscillator as Oscillators, index$1 as Sources, type index_StateChangeEvent as StateChangeEvent, type index_WaveOptions as WaveOptions, type index_WaveShaperFeedback as WaveShaperFeedback, type index_WaveformShaper as WaveformShaper, type index_Waveforms as Waveforms, index_adsr as adsr, index_adsrIterable as adsrIterable, index_arcShape as arcShape, index_defaultAdsrOpts as defaultAdsrOpts, index_jitter as jitter, index_jitterAbsolute as jitterAbsolute, index_pingPong as pingPong, index_pingPongPercent as pingPongPercent, index_sineBipolarShape as sineBipolarShape, index_sineShape as sineShape, index_squareShaper as squareShaper, index_triangleShaper as triangleShaper, index_wave as wave, index_waveFromSource as waveFromSource };
}

export { type AdsrOpts as A, type CompleteEvent as C, Envelope as E, Forces as F, Oscillator as O, type StateChangeEvent as S, type WaveformShaper as W, index$1 as a, type Waveforms as b, type WaveOptions as c, sineShape as d, arcShape as e, sineBipolarShape as f, type WaveShaperFeedback as g, waveFromSource as h, index as i, defaultAdsrOpts as j, type EnvelopeOpts as k, type AdsrTimingOpts as l, type Events as m, type Adsr as n, adsr as o, adsrIterable as p, type AdsrIterableOpts as q, squareShaper as s, triangleShaper as t, wave as w };
