...
__export(dom_exports, {
  ...
  getSizeWithBorder: () => getSizeWithBorder,
...
// src/dom/Css.ts
var getSizeWithBorder = (elOrQuery) => {
  const el2 = resolveEl(elOrQuery);
  const size = el2.getBoundingClientRect();
  const border = getComputedPixels(el2, `borderTopWidth`, `borderLeftWidth`, `borderRightWidth`, `borderBottomWidth`);
  return {
    x: size.x,
    y: size.y,
...
//# sourceMappingURL=chunk-DAFCVQ3V.js.map