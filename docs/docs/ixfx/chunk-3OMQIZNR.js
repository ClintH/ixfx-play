import { DomRx_exports, fullSizeCanvas, parentSizeCanvas, resizeObservable, windowResize } from "./chunk-OZOGN4QD.js";
import { SvgElements_exports } from "./chunk-GKSHN5ZH.js";
import { Forms_exports } from "./chunk-ZP4MNUF7.js";
import { pointsTracker, trackUniqueInstances } from "./chunk-TWQHDH3G.js";
import { setHtml, setProperty, setText } from "./chunk-VKL5W73U.js";
import { cardinal, empty, getPointParameter, guard, multiply, multiply2, point_exports, scaler, subtract } from "./chunk-Z5CX23RO.js";
import { resolveEl, resolveEls } from "./chunk-ZNCB3DZ2.js";
import { SimpleEventEmitter } from "./chunk-4Z4ZTA5P.js";
import { afterMatch } from "./chunk-G3ODKBFX.js";
import { round } from "./chunk-3NK3ODTY.js";
import { getErrorMessage } from "./chunk-4IJNRUE7.js";
import { __commonJS, __export, __toESM } from "./chunk-AFNFQUHK.js";
...
var parentSize = (domQueryOrEl, onResized, timeoutMs = 100) => {
    ...
    const ro = resizeObservable(parent, timeoutMs).onValue((entries) => {
...
var pointerVisualise = (elOrQuery, opts = {}) => {
    ...
    const trackPointer = async (event) => {
        ...
        const el22 = SvgElements_exports.circle({ ...pt, radius: type === `touch` ? touchRadius : mouseRadius }, svg, {
            fillStyle
...
export { CanvasHelper, setCssClass, setCssToggle, setCssDisplay, CssVariables_exports, DataTable_exports, DataDisplay, DragDrop_exports, el, elRequery, fullSizeElement, parentSize, defaultErrorHandler, log, inlineConsole, pointerVisualise, query, pointScaler, positionFn, cardinalPosition, positionRelative, viewportToSpace, positionFromMiddle, cycleCssClass, getTranslation, createAfter, createIn, clear, copyToClipboard, insertSorted, reconcileChildren, byId, dom_exports };
//# sourceMappingURL=chunk-3OMQIZNR.js.map
//# sourceMappingURL=chunk-3OMQIZNR.js.map