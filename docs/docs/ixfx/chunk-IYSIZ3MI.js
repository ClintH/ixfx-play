import { Bipolar_exports, flip } from "./chunk-2H7NNINZ.js";
import { averageWeighted } from "./chunk-ZFW25DXG.js";
import { interpolate, interpolateAngle, interpolatorInterval, interpolatorStepped } from "./chunk-O4F6U6KT.js";
import { NumberTracker, PrimitiveTracker, numberTracker } from "./chunk-R2SBCFPC.js";
import { arrays_exports } from "./chunk-I35SCU7G.js";
import { getSorter, minMaxAvg as minMaxAvg2 } from "./chunk-QB5BZLNL.js";
import { minMaxAvg } from "./chunk-LM2POA4U.js";
import { PointTracker, TrackedPointMap, pointTracker, pointsTracker, trackUnique, trackUniqueInstances } from "./chunk-TWQHDH3G.js";
import { DirectedGraph_exports, Pathed_exports, Process_exports, Table, combineLatestToObject, compareData as compareData2, isEmptyEntries, isEqualContextString, mapObjectShallow, resolveSource, sources_exports } from "./chunk-VKL5W73U.js";
import { wrap, wrapInteger, wrapRange } from "./chunk-T5BRTWW5.js";
import { scale, scaleClamped, scalePercent, scalePercentages, scaler, scalerPercent } from "./chunk-MWW5GJKZ.js";
import { TrackedValueMap, TrackerBase } from "./chunk-RRVLDWW5.js";
import { average } from "./chunk-IALMVFKW.js";
import { rateMinimum } from "./chunk-54QDRFLV.js";
import { clamp, clampIndex } from "./chunk-B6BKOHRA.js";
import { isPrimitive } from "./chunk-FVSZ5SVQ.js";
import { immutable } from "./chunk-G46LVJ4U.js";
import { QueueMutable } from "./chunk-ONNID4LF.js";
import { SimpleEventEmitter } from "./chunk-4Z4ZTA5P.js";
import { addKeepingExisting, addObject, deleteByValue, filter, find, firstEntryByIterablePredicate, firstEntryByIterableValue, fromIterable, fromObject, getClosestIntegerKey, getFromKeys, hasAnyValue, hasKeyValue, mapToArray, mapToObjectTransform, mergeByKey, some, sortByValue, sortByValueProperty, toArray, toObject, transformMap, zipKeyValue } from "./chunk-JHWLBJ5B.js";
import { changedDataFields, compareArrays, compareData, compareKeys } from "./chunk-EHDC2PRM.js";
import { numberTest, throwNumberTest } from "./chunk-2OY2BTO2.js";
import { logSet } from "./chunk-BWJ5AMOD.js";
import { getOrGenerate, getOrGenerateSync } from "./chunk-IQEKYUOH.js";
...
function pull(value) {
    ...
    const removeSource = (field, disposeOld) => {
        if (field in sources) {
            ...
            if (disposeOld)
                s.dispose(`ResolveFields.pull.removeSource`);
            return s;
        }
...
// src/data/index.ts
var piPi = Math.PI * 2;
export { Correlate_exports, FrequencyMutable, frequencyMutable, IntervalTracker, intervalTracker, keysToNumbers, movingAverageLight, movingAverageTimed, movingAverage, noiseFilter, Normalise_exports, compareDataExecute, Pool_exports, proportion, fieldResolve, fieldResolver, reactiveUpdate, pull, softmax, graphs_exports, maps_exports, piPi, data_exports };
//# sourceMappingURL=chunk-IYSIZ3MI.js.map
//# sourceMappingURL=chunk-IYSIZ3MI.js.map