...
import { clamp } from "./chunk-ZJSCF2A4.js";
import { pairwise } from "./chunk-BGQOJZFW.js";
import { defaultRandom } from "./chunk-5VWJ6TUI.js";
import { throwNumberTest } from "./chunk-CSXWZ3IC.js";
...
var resolve = (colour, safe = false) => {
    if (typeof colour === `string`) {
        ...
        if (isHsl(colour))
            return new Color(hslToColorJs(colour, safe));
        if (isRgb(colour))
...
export { toHsl, randomHue, resolve, resolveToString, toHex, opacity, getCssVariable, Colour_exports };
