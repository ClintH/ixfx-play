...
import { interpolateAngle } from "./chunk-O4F6U6KT.js";
import { Polar_exports, divide, getEdgeX, getEdgeY, point_exports, quadraticSimple, toPath } from "./chunk-Z5CX23RO.js";
import { scale } from "./chunk-MWW5GJKZ.js";
import { interval } from "./chunk-54QDRFLV.js";
import { StateMachineWithEvents } from "./chunk-MBIH4UNT.js";
import { frequencyTimer, msElapsedTimer } from "./chunk-CONPMDAT.js";
...
var AdsrBase = class extends SimpleEventEmitter {
    ...
    constructor(opts) {
        ...
        this.#sm = new StateMachineWithEvents(adsrTransitionsInstance, { initial: `attack` });
...
var constrainBounce = (bounds, dampen = 1) => {
    ...
    return (t) => {
        const position = computePositionFromVelocity(t.position ?? point_exports.Empty, t.velocity ?? point_exports.Empty);
...
var apply = (t, ...accelForces) => {
    ...
    const velo = computeVelocity(t.acceleration ?? point_exports.Empty, t.velocity ?? point_exports.Empty);
...
var springForce = (pinnedAt, restingLength = 0.5, k = 2e-4, damping = 0.999) => (t) => {
    ...
    const f = point_exports.pipelineApply(direction, point_exports.normalise, (p) => point_exports.multiply(p, -k * stretch));
    const accel = massApplyAccel(f, t, `dampen`);
    const velo = computeVelocity(accel ?? point_exports.Empty, t.velocity ?? point_exports.Empty);
...
export { defaultAdsrOpts, adsr, adsrIterable, Envelope_exports, Forces_exports, Oscillator_exports, sources_exports, triangleShaper, squareShaper, sineShape, arcShape, sineBipolarShape, wave, waveFromSource, modulation_exports };
//# sourceMappingURL=chunk-JRPIGEAG.js.map
//# sourceMappingURL=chunk-JRPIGEAG.js.map