import { isEqual } from "./chunk-KY2YJSDP.js";
import { IterableAsync_exports, average, chunks as chunks2, concat as concat2, dropWhile as dropWhile2, equals as equals2, every as every2, fill as fill2, filter as filter2, find as find2, flatten as flatten2, forEach as forEach2, fromArray as fromArray2, fromIterable as fromIterable2, map as map2, max as max2, max2 as max3, min as min2, min2 as min3, nextWithTimeout, rank, reduce as reduce2, slice as slice2, some as some2, sum, tally, toArray as toArray2, unique as unique2, uniqueByValue as uniqueByValue2, until as until2, zip as zip2 } from "./chunk-FWUJM2MQ.js";
import { resolveEl } from "./chunk-ZNCB3DZ2.js";
import { promiseFromEvent, sleep } from "./chunk-54QDRFLV.js";
import { Elapsed_exports } from "./chunk-CONPMDAT.js";
import { IterableSync_exports, chunks, concat, dropWhile, equals, every, fill, filter, find, flatten, forEach, fromArray, fromEvent, fromIterable, isAsyncIterable, isIterable, map, max, min, reduce, some, toArray, unique, uniqueByValue, until, zip } from "./chunk-FVSZ5SVQ.js";
import { Map_exports } from "./chunk-G46LVJ4U.js";
import { queue_exports } from "./chunk-2IZZMN3E.js";
import { intervalToMs } from "./chunk-LDUIWGOR.js";
import { slice } from "./chunk-TZZOFPLH.js";
import { isEqualValueIgnoreOrder, toStringDefault } from "./chunk-SGQC7FGM.js";
import { throwIntegerTest } from "./chunk-2OY2BTO2.js";
...
function fromIterable3(iterable2, interval) {
    if (isAsyncIterable(iterable2) || interval !== void 0)
        return fromIterable2(iterable2, interval);
    return fromIterable(iterable2);
}
export { chain_exports, combineLatestToArray2 as combineLatestToArray, min5 as min, max5 as max, dropWhile3 as dropWhile, until3 as until, chunks3 as chunks, filter4 as filter, fill3 as fill, concat3 as concat, find3 as find, forEach3 as forEach, map3 as map, fromArray3 as fromArray, flatten3 as flatten, some3 as some, reduce4 as reduce, slice3 as slice, unique3 as unique, uniqueByValue3 as uniqueByValue, toArray3 as toArray, every3 as every, equals3 as equals, zip3 as zip, fromIterable3 as fromIterable, iterables_exports };
//# sourceMappingURL=chunk-Z2L3DFWO.js.map
//# sourceMappingURL=chunk-Z2L3DFWO.js.map