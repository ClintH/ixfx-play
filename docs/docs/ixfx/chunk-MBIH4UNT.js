import { infinity, since } from "./chunk-CONPMDAT.js";
import { unique } from "./chunk-AMGGFK7I.js";
import { randomElement, shuffle } from "./chunk-KED2FGNI.js";
import { SimpleEventEmitter } from "./chunk-4Z4ZTA5P.js";
import { defaultComparer } from "./chunk-SB3LUXV4.js";
...
var fromList = (...states) => {
    ...
    for (let index = 0; index < states.length; index++) {
        ...
        if (typeof s !== `string`) {
            throw new TypeError(`Expected array of strings. Got type '${typeof s}' at index ${index}`);
        }
...
export { run, runSingle, init2 as init, StateMachineWithEvents, cloneState, init as init2, reset, validateMachine, done, possibleTargets, possible, normaliseTargets, to, next, isValidTransition, validateTransition, fromList, fromListBidirectional, StateMachine_exports };
//# sourceMappingURL=chunk-MBIH4UNT.js.map
//# sourceMappingURL=chunk-MBIH4UNT.js.map