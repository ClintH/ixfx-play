...
import { Elapsed_exports, frequencyTimer, frequencyTimerSource, hasElapsed, msElapsedTimer, relativeTimer, since, ticksElapsedTimer, toString } from "./chunk-CONPMDAT.js";
import { mutable } from "./chunk-ONNID4LF.js";
import { SimpleEventEmitter } from "./chunk-4Z4ZTA5P.js";
import { intervalToMs, isInterval } from "./chunk-LDUIWGOR.js";
import { integerTest, throwIntegerTest, throwNumberTest } from "./chunk-2OY2BTO2.js";
import { getErrorMessage } from "./chunk-4IJNRUE7.js";
import { resolveLogOption } from "./chunk-BWJ5AMOD.js";
...
var getName = (t, defaultValue = ``) => {
    if (typeof t === `object` && `name` in t && t.name !== void 0)
        return t.name;
    return defaultValue;
};
...
export { timeout, rateMinimum, DispatchList, continuously, sleep, sleepWhile, iterateBreadth, iterateDepth, debounce, delay, delayLoop, everyNth, forEach, forEachAsync, interval, promiseFromEvent, promiseWithResolvers, repeatAwait, repeat, RequestResponseMatch, backoffGenerator, retryFunction, retryTask, runOnce, SyncWait, TaskQueueMutable, throttle, updateOutdated, waitFor, WaitForValue, singleItem, flow_exports };
//# sourceMappingURL=chunk-54QDRFLV.js.map
//# sourceMappingURL=chunk-54QDRFLV.js.map