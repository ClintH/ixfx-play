import { resolve, toHex, toHsl } from "./chunk-MWW5GJKZ.js";
import { average, max, min, nextWithTimeout, rank, sum, tally } from "./chunk-FWUJM2MQ.js";
import { resolveEl, resolveEls } from "./chunk-ZNCB3DZ2.js";
import { DispatchList, continuously, sleep, timeout } from "./chunk-54QDRFLV.js";
import { StateMachine_exports } from "./chunk-MBIH4UNT.js";
import { Elapsed_exports } from "./chunk-CONPMDAT.js";
import { insertAt, remove } from "./chunk-A3UDCEP6.js";
import { shuffle } from "./chunk-KED2FGNI.js";
import { StackMutable, depthFirst, isAsyncIterable, isIterable, isPrimitive, map } from "./chunk-FVSZ5SVQ.js";
import { Map_exports, NumberMap, immutable } from "./chunk-G46LVJ4U.js";
import { PriorityMutable } from "./chunk-2IZZMN3E.js";
import { QueueMutable } from "./chunk-ONNID4LF.js";
import { intervalToMs } from "./chunk-LDUIWGOR.js";
import { getFromKeys, zipKeyValue } from "./chunk-JHWLBJ5B.js";
import { isInteger } from "./chunk-SB3LUXV4.js";
import { afterMatch, beforeMatch } from "./chunk-G3ODKBFX.js";
import { isPlainObjectOrPrimitive } from "./chunk-2P4HKZVW.js";
import { compareArrays, compareKeys } from "./chunk-EHDC2PRM.js";
import { isEqualDefault, isEqualValueDefault, toStringDefault } from "./chunk-SGQC7FGM.js";
import { getErrorMessage } from "./chunk-4IJNRUE7.js";
...
function object(initialValue, options = {}) {
    ...
    const update = (toMerge) => {
        if (value === void 0) {
            ...
            if (diffWithoutRemoved.length === 0)
                return value;
            value = {
                ...value,
                ...toMerge
...
function combineLatestToObject(reactiveSources, options = {}) {
    ...
    return {
        ...
        replaceSource(field2, source) {
            ...
            if (state === void 0)
                throw new Error(`Field does not exist: '${field2}'`);
            state.off();
...
export { mapObjectShallow, isEmptyEntries, isEqualContextString, compareData, getField, getPaths, Pathed_exports, Process_exports, messageIsSignal, messageIsDoneSignal, messageHasValue, hasLast, isReactive, isWritable, isWrapped, opify, isTriggerValue, isTriggerFunction, isTriggerGenerator, isTrigger, resolveTriggerValue, resolveSource, annotate, annotateWithOp, batch, transform, cloneFromFields, combineLatestToArray, combineLatestToObject, debounce, elapsed, field, filter, drop, max2 as max, min2 as min, average2 as average, sum2 as sum, tally2 as tally, rank2 as rank, pipe, singleFromArray, split, splitLabelled, switcher, syncToArray, syncToObject, tapProcess, tapStream, tapOps, throttle, timeoutTrigger, withValue, setText, setHtml, setProperty, setHtmlText, chainer, run, runHead, Table, DirectedGraph_exports, prepare, symbol, toArray, toArrayOrThrow, toGenerator, wrap, count, Dom_exports, sources_exports, manual, Sinks, Ops, takeNextValue, to, rx_exports };
//# sourceMappingURL=chunk-VKL5W73U.js.map
//# sourceMappingURL=chunk-VKL5W73U.js.map