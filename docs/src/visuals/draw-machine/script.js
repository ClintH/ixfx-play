...
import * as D from './drawing-util.js';
import { drawHeads } from './heads/draw.js';
...
setupCanvas();
const canvasDrawing = D.drawing(canvasContext);
const scalers = {
...
async function update() {
    ...
    for (const t of things.data) {
        ...
        //t.drawHead(canvasDrawing, t, scalers);
        drawHeads(heads, canvasDrawing);
