import"../../modulepreload-polyfill-B5Qt9EMX.js";import{g as n,p as u}from"../../geometry-CqFA_olX.js";import{i as C}from"../../iterables-k4l2dY5O.js";import{r as S}from"../../ui-DLgUXhoo.js";import{g as k,E as _,t as F}from"../../dom-CHyIdTDe.js";import"../../src-2eX6lIN8-VI_Nykma.js";import"../../src-CURfSkGx-Bgs9tt00.js";import"../../src-DUdYWbDU-DVRE-5Mg.js";import"../../records-Cei7yF1D-C5ys4Q3F.js";import"../../is-integer-BmMnD0ra-CbN5m7X_.js";import"../../src-CtUbQWIP-Vt_fnXRn.js";import"../../dist-DE4H3J9W-C3hFOwYK.js";import"../../src-3nHXiifJ-B3Cja0hK.js";const T=(s,t)=>{let i={x:0,y:0},e,l=()=>{};const d=async()=>{t&&t.clearVisited(),f&&f.restart()},p=()=>{const o=e.last(),h=o["visit-type"],c=o.reverse;return n.Visit.create(h,{start:i,boundsWrap:"undefined",reversed:c})(s)};let f=C({delay:50,iterator:()=>p(),onValue:o=>(t&&t.addVisited(o),!0)});return{id:"visit",label:"Visit",dismount:()=>{f.cancel(),l()},mount:o=>{o.innerHTML=`
      <form>
      ...
      <form>
      `,e=S.domForm("form"),l=e.onValue(o=>{d(o)})},notify:(a,o)=>{switch(a){case"click":{o||(o={x:0,y:0}),i=o,t&&(t.activated=[o]),d();break}default:console.warn(`visitPanel.notify: ${a}`)}}}},P=(s,t)=>{let i,e={x:0,y:0},l={x:0,y:0},d=!1,p=()=>{};const f=c=>{const r=u.fromString(c["a-xy"]??"0,0"),v=u.fromString(c["b-xy"]??"0,0");u.isNaN(r)||u.isNaN(v)||(e=r,l=v)},y=()=>{t&&t.clearVisited();const c=n.getLine(e,l);for(const r of c)t.addVisited(r)};return{id:"line",label:"Line",dismount:()=>{p()},mount:c=>{c.innerHTML=`
      <form>
